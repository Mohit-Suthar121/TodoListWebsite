    ...
    return (
        ...
        <div className='flex justify-between px-4'>
            ...
            <div className="logos flex ">
                <div onClick={()=>{props.handleEdit(props.id)}} className="edit-button cursor-pointer rounded-full w-10 h-10 flex justify-center items-center hover:bg-[#363636]">
                ...
                <div onClick={()=>{props.handleDelete(props.id)}} className="delete-button cursor-pointer rounded-full w-10 h-10 flex justify-center items-center hover:bg-[#363636]">
